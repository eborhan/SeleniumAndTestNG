...
public class BrowserUtils {
     ...
     * takes screenshot
     * @param name
     * take the name of the test and returns a path to the screenshot taken
     */
    public static String getScreenshot(String name) throws IOException {
        // name the screenshot with the current date time to avoid duplicates
        String date = new SimpleDateFormat("yyyyMMddhhmmss").format(new Date());
        // TakesScreenshot ---> an interface from Selenium that takes a screenshot
    ...
    /*
     * switches to new window by the exact title. Returns to the original window if the target title is not found
     * @param targetTitle
     */
    ...
    /*
     * Extracts a text from a list of elements matching the provided locator into new List<String>
    ...
    /*
     * Waits for the element matching the locator to be visible on the page
    ...
    /*
     * Waits for the element matching the locator to be clickable
    ...
    /*
     * Waits for bacground processes on the browser to be completed
     *
    ...
    public static void verifyElementDisplayed(By by) {
        try {
            Assert.assertTrue(Driver.get().findElement(by).isDisplayed(), "Element is not visible: " + by);
    ...
    /*
     * Waits for the element to be not stale
     *
     * @param element
     */
    ...
    /*
     * Checks or unchecks the given checkbox
     *
     * @param element
     * @param check
     */
    ...
    /*
     * attempts to click on the provided element until given time runs out
     *
     * @param element
     * @param timeout
     */
    ...
    /*
     * This method will recover in case of an exception after a click becomes unsuccessful,
     * and will try to click on the element again.
     *
     * @param by
     * @param attempts
     */
    ...
    /*
     *  checks that an element is present on the DOM of the page. This does not
